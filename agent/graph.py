...
def build_graph() -> StateGraph:
    ...
    Pipeline (no more sequential loop!):
      extract_pdf → analyze_document → process_sub_questions → final_synthesis → respond
    """
    ...
    workflow.add_edge("process_sub_questions", "final_synthesis")
